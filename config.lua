...
Config.Marker = {
  ["saint_dennis"] = {name = 'Saint Dennis', sprite = 1664425300, x = 2683.95, y = -1441.86, z = 46.16},
  ["rhodes"] = {name = 'Rhodes', sprite = 1664425300, x = 1254.05, y = -1327.07, z = 76.89}
}
...
Config.Coords = {
	vector3(-214.41, 646.37, 112.95),
	vector3(-807.41, -1385.16, 43.49)
}
